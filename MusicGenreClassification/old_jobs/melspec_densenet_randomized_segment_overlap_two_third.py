...
for kfold, (train_index, test_index) in enumerate(skf.split(dataset.X, dataset.Y)):
    ...
    info = {}
    tb_writer = SummaryWriter('runs/densenet_randomized_segment_fold_overlap_2_3_%d' % kfold)
    ...
    with open('checkpoints/densenet_randomized_segment_fold_overlap_2_3_%d.pth' % kfold, 'wb') as f:
